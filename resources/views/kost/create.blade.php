                    ...
                    <div class="glass-card">
                        ...
                        <div class="form-header">
                            ...
                            <div>
                                ...
                                <small style="color: var(--text-muted);">Lengkapi data properti kost Anda di bawah ini</small>
                            </div>
                        </div>
                            ...
                            <form action="{{ route('pemilik.kos.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                                              name="deskripsi" rows="3" placeholder="Jelaskan fasilitas (Wifi, AC, dll)..." required>{{ old('deskripsi') }}</textarea>
    ...
    <script>
        function previewFile(input) {
            ...
            if(file){
                ...
                icon.style.color = '#10b981'; // Warna hijau sukses
            }
        }
    </script>
