        ...
        <div class="container">
            ...
            <div class="page-header">
                ...
                <div class="mt-3 mt-lg-0">
                    <a href="{{ route('pemilik.kos.create') }}" class="btn-add-kost">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('pemilik.kos.edit', $kost->kos_id) }}" class="action-btn btn-edit" title="Edit Data">
                                        <i class="fas fa-pen"></i>
                                    </a>

                                    <form action="{{ route('pemilik.kos.destroy', $kost->kos_id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
